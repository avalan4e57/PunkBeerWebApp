...
var _QueryResponse = __webpack_require__(20);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'app' },
        _react2.default.createElement(_SearchBar2.default, { query: this.state.query, onSubmit: this.handleSubmit, onChange: this.handleChange }),
        _react2.default.createElement(_QueryResponse2.default, { searchQuery: this.state.searchQuery })
      );
    }
  }]);
...
var SearchBar = function SearchBar(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement("input", { type: "text", value: query, onChange: onChange, name: "search-field", placeholder: "Search for beer...", className: "form-control" }),
...
var QueryResponse = function (_React$Component) {
  _inherits(QueryResponse, _React$Component);

  function QueryResponse(props) {
    _classCallCheck(this, QueryResponse);

    var _this = _possibleConstructorReturn(this, (QueryResponse.__proto__ || Object.getPrototypeOf(QueryResponse)).call(this, props));
  ...
  _createClass(QueryResponse, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.searchQuery !== nextProps.searchQuery) {
        var curQuery = nextProps.searchQuery == 'all' ? '' : nextProps.searchQuery;
        fetch('https://api.punkapi.com/v2/beers/' + curQuery).then(function (resp) {
          return resp.json();
        }).then(function (data) {
